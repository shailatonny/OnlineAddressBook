...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td width="15" nowrap="nowrap"><img src='<c:url value="/images/mm_spacer.gif"/>' alt="" width="15" height="1"
                                            border="0"/></td>
    ...
    <tr bgcolor="#a4c2c2">
        ...
        <td height="36" colspan="3" id="navigation" class="navText"><a href="javascript:;">OUR ROOMS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="javascript:;">ABOUT US</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="javascript:;">MAKE A
                RESERVATION</a>&nbsp;&nbsp;
    ...
    <tr bgcolor="#ffffff">
        <td width="230" colspan="2" valign="top" bgcolor="#a4c2c2"><img
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="230">
                <tr>
                    <td width="15">&nbsp;</td>
                    <td width="200" class="sidebarText" id="padding">Quis est, quod ibi homo vult dolere luctuosa et
                        tragica, quae tamen pati ipse nollet.<br/>
                        &nbsp;<br/></td>
                    <td width="15">&nbsp;</td>
                </tr>
            </table>
